...
import type { Blog as _Blog } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async createBlog(arg0: CreateBlogInput): Promise<{
        __kind__: "ok";
        ok: Blog;
    } | {
        __kind__: "err";
    ...
    async deleteBlog(arg0: string): Promise<{
        __kind__: "ok";
        ok: null;
    } | {
        __kind__: "err";
    ...
    async getBlogBySlug(arg0: string): Promise<Blog | null> {
        if (this.processError) {
            try {
    ...
    async getBlogsPaginated(arg0: bigint, arg1: bigint, arg2: string, arg3: string): Promise<PaginatedBlogs> {
        if (this.processError) {
            try {
                const result = await this.actor.getBlogsPaginated(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBlog(arg0: string, arg1: UpdateBlogInput): Promise<{
        __kind__: "ok";
        ok: Blog;
    } | {
        __kind__: "err";
...
function from_candid_opt_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Blog]): Blog | null {
