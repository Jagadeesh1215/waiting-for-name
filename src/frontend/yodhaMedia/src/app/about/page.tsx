...
const steps = [
  { num: '01', title: 'Understand', desc: 'We deep-dive into your business, audience, goals, and competitive landscape' },
  { num: '02', title: 'Build', desc: 'We create content, campaigns, and assets tailored to your brand identity' },
  { num: '03', title: 'Execute', desc: 'We manage all platforms, campaigns, and communications on your behalf' },
  { num: '04', title: 'Optimize & Grow', desc: 'We track performance, iterate, and scale what works continuously' },
]

const differentiators = [
  { icon: '✅', title: 'Integrated Strategy', desc: 'Content, marketing & distribution working as one unified system' },
  { icon: '🏥', title: 'Healthcare Focus', desc: 'Dedicated expertise for hospitals, doctors, and medical professionals' },
  { icon: '🤝', title: 'Business Hub Network', desc: 'Strong influencer network and city-level distribution channels' },
  { icon: '📋', title: 'Structured Workflows', desc: 'Consistent execution frameworks for quality and predictability' },
  { icon: '🛡️', title: 'Ethical Approach', desc: 'Compliance-focused strategy that builds long-lasting trust' },
]
...
const infoColumns = [
  ...
  },
  {
    ...
    items: ['Hospitals & Healthcare', 'Individual Doctors & Clinics', 'Businesses & Service Providers', 'Emerging Brands', 'E-commerce', 'Professional Services'],
    isList: true,
...
const springCard = {
  ...
  visible: (i: number) => ({
    opacity: 1,
    scale: 1,
    transition: { type: 'spring' as const, damping: 10, stiffness: 200, delay: i * 0.1 },
  }),
}
  ...
  return (
    <PublicLayout>
      <main className="overflow-x-hidden">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <ScrollReveal direction="left">
                ...
                <p className="text-brand-text-secondary dark:text-white/70 text-lg leading-relaxed mb-8">
                  We help hospitals, doctors, and businesses build a strong, consistent, and result-driven digital presence through structured systems and strategic execution.
                </p>
                <motion.button
                  type="button"
              ...
              <ScrollReveal direction="right">
                <div className="relative rounded-2xl overflow-hidden h-96 bg-gradient-to-br from-brand-purple via-brand-purple-2 to-violet-500 flex items-center justify-center shadow-2xl">
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <span className="text-white/90 font-heading font-bold text-2xl tracking-wide">VenIQ Media</span>
                    <p className="text-white/60 text-sm mt-1 font-mono">Digital Growth Agency</p>
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-14 items-start">
              ...
              >
                ...
                <p>
                  VenIQ Media LLP is a full-service digital growth agency founded with one mission — to help modern businesses build a strong, consistent, and result-driven digital presence.
                </p>
                <p>
                  We specialize in serving hospitals, individual doctors, clinics, and growing businesses across India. Our integrated approach combines content creation, digital marketing, and strategic distribution to deliver measurable results.
                </p>
                <p>
                  Our team of specialists in social media, SEO, branding, and digital advertising work as an extension of your team — consistently executing your digital strategy so you can focus on what matters most: your business.
                </p>
              </ScrollReveal>
              ...
              <div className="grid grid-cols-2 gap-4">
                {stats.map((stat, i) => (
                  <motion.div
                    ...
                    whileHover={{ y: -4, boxShadow: '0 12px 28px rgba(212,160,23,0.18)' }}
                  ...
                  >
                    <div className="text-4xl font-display font-bold text-brand-gold mb-1">{stat.value}</div>
                    <div className="text-sm text-brand-text-secondary dark:text-white/60 font-heading">{stat.label}</div>
                  </motion.div>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {services.map((svc, i) => (
                ...
                >
                  ...
                  <p className="font-heading font-semibold text-sm text-brand-purple dark:text-white leading-snug">{svc.name}</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20 bg-brand-purple dark:bg-brand-bg-dark" data-ocid="about.differentiators.section">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
              {differentiators.map((d, i) => (
                ...
                >
                  ...
                  <h3 className="font-heading font-bold text-white text-sm mb-1.5">{d.title}</h3>
              ...
              {infoColumns.map((col, i) => (
                ...
                >
                  <div className="bg-white dark:bg-brand-card-dark border border-brand-border-light dark:border-white/10 rounded-2xl p-6 h-full">
                    <h3 className="font-heading font-bold text-brand-gold mb-3 text-sm uppercase tracking-wide">{col.title}</h3>
                    {col.isList ? (
                      <ul className="space-y-1.5">
                        {col.items?.map((item) => (
                          <li key={item} className="flex items-start gap-2 text-sm text-brand-text-secondary dark:text-white/70">
                      ...
                      <p className="text-sm text-brand-text-secondary dark:text-white/70 leading-relaxed">{col.content}</p>
                    )}
                  </div>
                </motion.div>
              ))}
          ...
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <ScrollReveal>
              ...
              <p className="text-brand-text-secondary dark:text-white/70 mb-8 text-lg">
                Ready to grow? Let's create a digital strategy that delivers real results for your business.
              </p>
