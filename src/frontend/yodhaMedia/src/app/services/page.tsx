...
const coreServices = [
  {
    num: '01', icon: '📱', name: 'Social Media Partner', category: 'Content Strategy',
    desc: 'End-to-end social media management that builds brand visibility and drives engagement across all platforms.',
    bullets: ['Content calendar & script writing', 'Video shooting & reel editing', 'Carousel design & content approval', 'Account management & engagement monitoring'],
    bestFor: 'Hospitals, doctors, and businesses needing consistent social presence', slug: 'social-media-partner',
  },
  {
    num: '02', icon: '⭐', name: 'Online Reputation Management', category: 'ORM',
    desc: 'Protect and enhance your online reputation with proven strategies that build trust and visibility.',
    bullets: ['Google Business Profile optimization', 'Review management & response strategy', 'Local SEO and map visibility', 'Digital visiting cards'],
    bestFor: 'Doctors, clinics, and local businesses', slug: 'orm',
  },
  {
    num: '03', icon: '🎨', name: 'Branding Partner', category: 'Print & Offline Design',
    desc: 'Professional design services that make your brand stand out — both online and in the physical world.',
    bullets: ['Banners, hoardings & canopy tents', 'Posters, flyers & print collateral', 'Brand guidelines & identity design', 'Offline marketing materials'],
    bestFor: 'Businesses establishing or refreshing their brand', slug: 'branding-partner',
  },
  {
    num: '04', icon: '💻', name: 'Web Designing', category: 'Digital Presence',
    desc: 'Modern, responsive websites built for performance, user experience, and search engine visibility.',
    bullets: ['Modern responsive website development', 'Blog integration & maintenance', 'SEO structure & performance optimization', 'UI/UX design with conversion focus'],
    bestFor: 'Any business needing a professional website', slug: 'web-designing',
  },
  {
    num: '05', icon: '📊', name: 'Digital Marketing', category: 'Paid Ads',
    desc: 'Data-driven paid advertising campaigns on Meta and Google that deliver measurable ROI.',
    bullets: ['Meta Ads (Facebook + Instagram) management', 'Google Ads campaign setup & management', 'Strategy, optimization & A/B testing', 'Detailed reporting & performance tracking'],
    bestFor: 'Businesses ready to invest in paid growth', slug: 'digital-marketing',
  },
  {
    num: '06', icon: '🌟', name: 'Influencer Marketing', category: 'Network Reach',
    desc: 'Leverage our network of trusted influencers and city pages to reach targeted local audiences at scale.',
    bullets: ['Influencer collaborations & negotiations', 'City page promotions & sponsored posts', 'Campaign management & execution', 'Budget optimization & ROI tracking'],
    bestFor: 'Brands needing reach and trust through creators', slug: 'influencer-marketing',
  },
]

const processSteps = [
  { num: '01', title: 'Strategy', desc: 'Understand your business, audience, and goals' },
  { num: '02', title: 'Creation', desc: 'Build content and assets that reflect your brand' },
  { num: '03', title: 'Execution', desc: 'Manage platforms, campaigns, and communications' },
  { num: '04', title: 'Growth', desc: 'Track, optimize, and scale continuously' },
]

const whyChoose = [
  { icon: '🔗', title: 'Integrated Ecosystem', desc: 'All services work together for amplified results' },
  { icon: '🏥', title: 'Healthcare Focus', desc: 'Deep expertise in medical & healthcare marketing' },
  { icon: '📡', title: 'Strong Distribution', desc: 'Business Hub network + influencer reach' },
  { icon: '⚙️', title: 'Consistent Execution', desc: 'Structured workflows ensure quality every time' },
  { icon: '🛡️', title: 'Ethical Approach', desc: 'Compliance-focused, transparent practices' },
]

const distributionBenefits = [
  { icon: '🌐', text: 'Access to 50+ Business Hub pages and city-specific audiences' },
  { icon: '📱', text: 'Established influencer network across multiple categories' },
  { icon: '📊', text: 'Paid ad expertise reaching hyper-targeted local audiences' },
]

const PARTICLES = Array.from({ length: 8 }, (_, i) => ({
  id: i, left: `${10 + i * 12}%`, top: `${15 + (i % 3) * 30}%`, delay: i * 0.4,
...
const serviceCardSpring = {
  ...
  visible: (i: number) => ({
    opacity: 1, scale: 1,
    transition: { type: 'spring' as const, damping: 10, stiffness: 200, delay: i * 0.08 },
  }),
}
  ...
  return (
    <PublicLayout>
      <main className="overflow-x-hidden">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <ScrollReveal direction="left">
                ...
                <p className="text-brand-text-secondary dark:text-white/70 text-lg leading-relaxed mb-2">
                  We offer integrated digital services that help businesses, hospitals, and professionals build visibility, credibility, and consistent growth.
                </p>
                <p className="text-brand-text-secondary dark:text-white/60 text-base leading-relaxed mb-8">
                  From content creation to marketing execution and distribution — everything is managed under one structured system.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <motion.div whileTap={{ scale: 0.97 }}>
                    <Link
                      href="/services/social-media-partner"
              ...
              <ScrollReveal direction="right">
                <div className="relative rounded-2xl overflow-hidden h-80 bg-gradient-to-br from-brand-purple via-indigo-700 to-brand-purple-2 flex items-center justify-center shadow-2xl">
                  <div
                    ...
                    style={{ background: 'radial-gradient(circle at 30% 40%, #D4A017 0%, transparent 50%), radial-gradient(circle at 70% 60%, #4A2C9E 0%, transparent 50%)' }}
                  />
                  <div className="relative z-10 text-center">
                    <div className="text-5xl mb-2">🚀</div>
                    <span className="text-white/80 font-mono text-sm uppercase tracking-widest">Growth Platform</span>
                    <p className="text-white/50 text-xs mt-1">Integrated Digital System</p>
                  </div>
            ...
            <ScrollReveal>
              <div className="border-2 border-brand-border-light dark:border-white/10 rounded-2xl p-8 md:p-10 text-center">
                ...
                <p className="text-brand-text-secondary dark:text-white/70 leading-relaxed">
                  At VenIQ Media, we don't offer isolated services. We build an integrated digital growth system where every component — content, marketing, SEO, and distribution — works together to amplify your results. Our structured approach ensures consistency, quality, and measurable outcomes at every stage.
                </p>
              </div>
            </ScrollReveal>
          </div>
                ...
                >
                  <div className="flex items-start gap-3 mb-4">
                    <div
                      ...
                      style={{ background: 'linear-gradient(135deg, #D4A017 0%, #F0C040 100%)', boxShadow: '0 0 10px rgba(212,160,23,0.35)' }}
                    >
                      {svc.num}
                    </div>
                    <motion.div className="text-4xl" whileHover={{ scale: 1.12 }} transition={{ type: 'spring', stiffness: 300 }}>
                      {svc.icon}
                    </motion.div>
                  </div>

                  <h3 className="font-heading font-bold text-brand-purple dark:text-white text-lg mb-1">{svc.name}</h3>
                  <span className="text-brand-gold text-xs font-mono uppercase tracking-wide mb-3">{svc.category}</span>
                  <p className="text-sm text-brand-text-secondary dark:text-white/60 leading-relaxed mb-4">{svc.desc}</p>

                  <ul className="space-y-1.5 mb-4 flex-1">
                    {svc.bullets.map((b) => (
                      <li key={b} className="flex items-start gap-2 text-sm text-brand-text-secondary dark:text-white/60">
                  ...
                  <p className="text-xs italic text-brand-text-secondary/70 dark:text-white/40 mb-4">
                    <span className="font-semibold not-italic text-brand-purple dark:text-white/70">Best For:</span>{' '}
                    {svc.bestFor}
                  </p>
        ...
        <section className="py-20 bg-brand-purple dark:bg-brand-bg-dark relative overflow-hidden" data-ocid="services.distribution.section">
          {PARTICLES.map((p) => (
            <motion.div
              key={p.id}
              ...
              transition={{ duration: 3 + p.delay, repeat: Number.POSITIVE_INFINITY, ease: 'easeInOut', delay: p.delay }}
            />
          ))}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <ScrollReveal direction="left">
                <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-2">Our Distribution Advantage</h2>
                <p className="text-white/60 font-heading text-lg mb-8">Powered by Our Business Hub Network</p>
                <ul className="space-y-5">
                  {distributionBenefits.map((b) => (
                    <li key={b.text} className="flex items-start gap-4">
                      <span className="text-2xl shrink-0">{b.icon}</span>
                      <span className="text-white/80 leading-relaxed">{b.text}</span>
                    </li>
                  ))}
                </ul>
              </ScrollReveal>
              ...
              {processSteps.map((step, i) => (
                ...
                >
                  <div
                    ...
                    style={{ background: 'linear-gradient(135deg, #D4A017 0%, #F0C040 100%)', boxShadow: '0 0 12px rgba(212,160,23,0.4)' }}
                  >
                    {step.num}
                  </div>
                  <h3 className="font-heading font-bold text-brand-purple dark:text-white mb-2">{step.title}</h3>
                  <p className="text-sm text-brand-text-secondary dark:text-white/60 leading-relaxed">{step.desc}</p>
                </motion.div>
              ))}
            </motion.div>
          </div>
            ...
            >
              {whyChoose.map((item, i) => (
                <motion.div
                  ...
                  whileHover={{ y: -4, boxShadow: '0 12px 28px rgba(45,27,105,0.15)' }}
                  whileTap={{ scale: 0.97 }}
                ...
                >
                  ...
                  <h3 className="font-heading font-bold text-brand-purple dark:text-white text-sm mb-1">{item.title}</h3>
                  <p className="text-xs text-brand-text-secondary dark:text-white/50 leading-snug">{item.desc}</p>
                </motion.div>
              ))}
            </motion.div>
          </div>
          ...
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <ScrollReveal>
              ...
              <p className="text-brand-text-secondary dark:text-white/70 mb-8 text-lg">
                Ready to scale your digital presence? Let's create an integrated system that delivers real, measurable results.
              </p>
