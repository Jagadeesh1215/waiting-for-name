...
const Hero3DScene = dynamic(
  () => import("@/components/3d/Hero3DScene").then((m) => ({ default: m.Hero3DScene })),
  { ssr: false },
);
    ...
    <div className="overflow-x-hidden">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 w-full grid lg:grid-cols-5 gap-12 items-center py-16">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            >
              <span className={`${sectionLabelClass} inline-block mb-3`}>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <ScrollReveal className="text-center mb-14">
            <span className={`${sectionLabelClass} block mb-3`}>
              WHO WE HELP
            </span>
            ...
            <p className="text-brand-text-secondary dark:text-white/60 max-w-xl mx-auto font-body">
              We partner with businesses and professionals who value
              consistency, quality, and long-term growth.
            </p>
          </ScrollReveal>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <ScrollReveal className="text-center mb-4">
            ...
            <p className="text-brand-text-secondary dark:text-white/60 max-w-2xl mx-auto font-body">
              We don't offer isolated services — we build integrated systems
              that work together to deliver results.
            </p>
          </ScrollReveal>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {PROCESS_STEPS.map((step, i) => (
                <motion.div
                  key={step.num}
                  variants={
                    step.dir === "left" ? processSlideLeft : processSlideRight
                  }
                  initial="hidden"
                  whileInView="visible"
                  viewport={{ once: true, amount: 0.4 }}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <ScrollReveal className="text-center mb-14">
            ...
            <p className="text-white/70 max-w-2xl mx-auto font-body text-lg leading-relaxed">
              ...
              distribution systems to create compounding growth for your
              business.
            </p>
          </ScrollReveal>
          ...
          >
            {OUTCOMES.map((outcome) => (
              ...
              >
                ...
                <p className="font-body text-brand-text-secondary dark:text-white/70 text-sm">
                  {outcome}
                </p>
              </motion.div>
            ))}
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(74,44,158,0.3) 0%, transparent 70%)",
          }}
        />
        <div
