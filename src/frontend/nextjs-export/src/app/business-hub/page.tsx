        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            ...
            <p className="text-brand-text-secondary dark:text-white/70 text-xl leading-relaxed mb-4 max-w-3xl mx-auto">
              Connecting businesses, brands, and professionals with targeted,
              engaged audiences across cities and niches.
            </p>
            <p className="text-brand-text-secondary dark:text-white/60 text-base leading-relaxed mb-10 max-w-2xl mx-auto">
              Our Business Hub pages are city-specific and niche-targeted social
              media pages with large, engaged followings — giving your business
              instant access to the right audience.
            </p>
          ...
          <ScrollReveal delay={0.2}>
            <div className="mt-14 relative max-w-2xl mx-auto">
              <div className="rounded-3xl overflow-hidden h-64 bg-gradient-to-br from-brand-purple via-brand-purple-2 to-violet-500 flex items-center justify-center shadow-2xl">
                <div className="text-center">
                  <div className="text-6xl mb-4">🌐</div>
                  <span className="text-white font-heading font-bold text-2xl tracking-wide block">
                    Business Hub Network
                  </span>
                  <p className="text-white/70 font-mono text-sm mt-2">
                    50+ Pages · 500K+ Reach · 20+ Cities
                  </p>
                </div>
          ...
          >
            {whatIsHub.map((item) => (
              ...
              >
                ...
                <h3 className="font-heading font-bold text-brand-purple dark:text-white text-xl mb-3">
                  {item.title}
                </h3>
                <p className="text-brand-text-secondary dark:text-white/60 leading-relaxed text-sm">
                  {item.desc}
                </p>
              </motion.div>
            ))}
            ...
            {howItWorks.map((step, i) => (
              ...
              >
                ...
                >
                  ...
                  <h3 className="font-heading font-bold text-brand-purple dark:text-white text-lg mb-2">
                    {step.title}
                  </h3>
                  <p className="text-brand-text-secondary dark:text-white/60 text-sm leading-relaxed">
                    {step.desc}
                  </p>
                </div>
              </ScrollReveal>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
              The VenIQ Business Hub Advantage
            </h2>
            <p className="text-white/70 text-base mb-12 max-w-xl mx-auto">
              Our growing network of city and niche pages gives your business
              access to ready, engaged audiences without the wait.
            </p>
          </ScrollReveal>
            ...
            {benefits.map((b, i) => (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-heading font-bold text-brand-purple dark:text-white text-base mb-1">
                      {b.title}
                    </h3>
                    <p className="text-brand-text-secondary dark:text-white/60 text-sm leading-relaxed">
                      {b.desc}
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {[...Array(12)].map((_, i) => (
            <motion.div
              ...
              style={{
                width: (i * 13 + 20) % 100 + 20,
                height: (i * 13 + 20) % 100 + 20,
                left: `${(i * 8 + 5) % 100}%`,
                top: `${(i * 11 + 3) % 100}%`,
              }}
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            ...
            <p className="text-white/70 text-lg mb-10 max-w-2xl mx-auto">
              Get your business featured on our city and niche pages — reach
              thousands of local, engaged followers.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <motion.button
                type="button"
