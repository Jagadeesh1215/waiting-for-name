...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  "Influencer Marketing":
    "bg-pink-50 text-pink-700 border-pink-200 dark:bg-pink-900/20 dark:text-pink-300",
  "Website & Branding":
...
const MOCK_POSTS: MockPost[] = [
  {
    ...
    readTime: "5 min",
    excerpt:
      "Discover how leading hospitals and clinics are leveraging Instagram, Facebook, and YouTube to build patient trust and drive appointments.",
    publishDate: "2025-12-15",
    keyTakeaway:
      "Hospitals using a consistent social media strategy see up to 3x more online appointment bookings within 6 months of implementation.",
  ...
  },
  {
    ...
    readTime: "8 min",
    excerpt:
      "A complete step-by-step guide to optimize your Google Business Profile and dominate local search for your medical practice.",
    publishDate: "2025-12-10",
    keyTakeaway:
      "A fully optimized Google Business Profile can increase your clinic's local search visibility by 70% and drive significantly more walk-in and appointment-based patients.",
  ...
  },
  {
    ...
    readTime: "6 min",
    excerpt:
      "Struggling to create engaging reels for your healthcare brand? Here are 10 proven content ideas that drive views and build trust.",
    publishDate: "2025-12-05",
    keyTakeaway:
      "Educational reels that address common patient questions consistently outperform promotional content, generating 4x more organic reach for healthcare brands.",
  ...
  },
  {
    ...
    readTime: "7 min",
    excerpt:
      "A data-driven comparison of Meta Ads and Google Ads specifically for healthcare providers — find out which delivers better ROI.",
    publishDate: "2025-11-28",
    keyTakeaway:
      "For most clinics, Google Ads delivers higher-intent leads while Meta Ads excel at brand awareness — a combined strategy typically yields the best ROI.",
  ...
  },
  {
    ...
    readTime: "4 min",
    excerpt:
      "Your brand is more than a logo. Learn how digital branding can differentiate your business and build lasting customer loyalty.",
    publishDate: "2025-11-20",
    keyTakeaway:
      "Businesses with a defined digital branding strategy retain customers 33% longer and see significantly higher referral rates than those without one.",
  ...
  },
  {
    ...
    readTime: "6 min",
    excerpt:
      "Not all influencer collaborations are equal. Learn the proven framework for successful healthcare influencer campaigns.",
    publishDate: "2025-11-15",
    keyTakeaway:
      "Micro-influencers with 10k–50k followers in healthcare niches deliver 60% higher engagement rates than macro-influencers for medical and wellness brands.",
  ...
  },
  {
    ...
    readTime: "9 min",
    excerpt:
      "Rank higher on Google Maps and attract more local patients with these proven local SEO strategies specifically for clinics.",
    publishDate: "2025-11-08",
    keyTakeaway:
      "Clinics that consistently post updates and manage reviews on Google Business Profile rank in the top 3 local results 2x more often than those that don't.",
    tags: [
      "Local SEO",
      "Google Maps",
      "Clinic Marketing",
  ...
  },
  {
    ...
    readTime: "5 min",
    excerpt:
      "Download-ready content calendar framework for hospitals and clinics, including post ideas, hashtag strategies, and posting schedules.",
    publishDate: "2025-11-01",
    keyTakeaway:
      "Healthcare brands posting 4–5 times per week with a structured content calendar see 45% higher follower growth compared to ad-hoc posting strategies.",
  ...
  },
  {
    ...
    readTime: "4 min",
    excerpt:
      "Practical strategies to generate authentic 5-star Google reviews that build trust and drive new patient appointments.",
    publishDate: "2025-10-22",
    keyTakeaway:
      "Simply asking patients to leave a review at checkout increases review generation by 300% — timing and the right ask make all the difference.",
    tags: [
      "Reviews",
        ...
        >
          ...
          <AnimatePresence initial={false}>
            {openIdx === i && (
              ...
              >
                <div className="px-5 pb-5 pt-1 text-brand-text-secondary dark:text-white/70 text-sm leading-relaxed border-t border-brand-border-light dark:border-white/10">
                  {item.a}
                </div>
              </motion.div>
            )}
  ...
  return (
    <div className="prose prose-slate dark:prose-invert max-w-none">
      <p className="text-brand-text-secondary dark:text-white/70 leading-relaxed text-base">
        In today's competitive digital landscape, businesses and healthcare
        professionals cannot afford to ignore their online presence. The
        strategies we're about to explore have been proven across 50+ client
        engagements, delivering consistent, measurable growth for hospitals,
        clinics, and modern businesses across India.
      </p>
      ...
      <p className="text-brand-text-secondary dark:text-white/70 leading-relaxed text-base">
        The digital revolution has fundamentally changed how patients choose
        healthcare providers and how customers discover businesses. Over 87% of
        Indians now search online before making a healthcare decision. Without a
        strong digital presence, even the most skilled professionals risk
        remaining invisible to their ideal clients.
      </p>
      <p className="text-brand-text-secondary dark:text-white/70 leading-relaxed text-base mt-4">
        This isn't just about having a website or social media account — it's
        about building a cohesive, trust-driven digital ecosystem that works
        24/7 to grow your practice or business.
      </p>
      ...
      <ol className="list-decimal list-inside space-y-3 text-brand-text-secondary dark:text-white/70 text-base">
        <li className="leading-relaxed">
          <strong className="text-brand-text-primary dark:text-white">
            Establish a consistent brand voice
          </strong>{" "}
          — Consistency across all touchpoints builds recognition and trust over
          time.
        </li>
        <li className="leading-relaxed">
          <strong className="text-brand-text-primary dark:text-white">
          ...
          — Use analytics to understand what resonates with your audience and
        ...
        <li className="leading-relaxed">
          ...
          — Most healthcare and service queries are local. Ensure your Google
          Business Profile and local SEO are airtight.
        </li>
        <li className="leading-relaxed">
          <strong className="text-brand-text-primary dark:text-white">
            Build social proof systematically
          </strong>{" "}
          — Reviews, testimonials, and case studies convert far better than
          promotional content.
        </li>
        <li className="leading-relaxed">
          <strong className="text-brand-text-primary dark:text-white">
          ...
          — A siloed approach to digital marketing leaves significant growth on
          the table. Integration multiplies results.
        </li>
      </ol>
      ...
      <p className="text-brand-text-secondary dark:text-white/70 leading-relaxed text-base">
        Starting can feel overwhelming. The key is to begin with a solid
        foundation and build systematically. Focus on the 20% of actions that
        drive 80% of results — typically your Google Business Profile, a
        consistent social media cadence, and proactive review management form
        this core foundation for most healthcare and service businesses.
      </p>
      <p className="text-brand-text-secondary dark:text-white/70 leading-relaxed text-base mt-4">
        Track your metrics weekly, not monthly. Early data signals help you
        course-correct before investing too much in a direction that isn't
        yielding results.
      </p>
      ...
      <p className="text-brand-text-secondary dark:text-white/70 leading-relaxed text-base">
        The path to sustainable digital growth isn't about chasing trends — it's
        about building integrated systems that compound over time. Whether
        you're a hospital, a solo practitioner, or a growing business, the
        fundamentals remain the same: visibility, trust, and consistency. Start
        today, stay consistent, and let the data guide your evolution.
      </p>
    </div>
  );
}
...
export default function BlogPostPage() {
  ...
  const loadPost = useCallback(async () => {
    ...
    try {
      ...
      if (data) {
        ...
        const mock =
          MOCK_POSTS.find((p) => p.slug === currentSlug) ?? MOCK_POSTS[0];
        setMockPost(mock);
        setBlog(null);
      }
    } catch {
  ...
  const nextPost =
    currentMockIdx < MOCK_POSTS.length - 1
      ? MOCK_POSTS[currentMockIdx + 1]
      : null;
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-10 gap-10">
            <div className="lg:col-span-7 space-y-6 animate-pulse">
              ...
              <div className="h-6 w-48 bg-brand-border-light dark:bg-white/10 rounded-full" />
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-brand-bg-light dark:bg-brand-bg-dark">
        <div className="text-center">
          ...
          <h1 className="font-display text-3xl font-bold text-brand-text-primary dark:text-white mb-4">
            Article Not Found
          </h1>
          <p className="text-brand-text-secondary dark:text-white/60 mb-6">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        >
          ...
          <article className="lg:col-span-7" data-ocid="blog.post.article">
            ...
            {/* Title */}
            <ScrollReveal>
              <h1 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-brand-text-primary dark:text-white leading-tight mb-5">
                {post.title}
              </h1>
            </ScrollReveal>
            ...
            <div className="flex flex-wrap items-center gap-3 mb-8">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-brand-purple to-brand-purple-2 flex items-center justify-center text-white text-xs font-bold">
                  V
                </div>
                <span className="text-sm font-heading font-medium text-brand-text-primary dark:text-white">
                  VenIQ Media Team
                </span>
              </div>
              <span className="text-brand-border-light dark:text-white/20">
                •
              </span>
              ...
              <span className="bg-brand-bg-light dark:bg-white/5 text-brand-text-secondary dark:text-white/60 px-3 py-1 rounded-full text-xs font-mono">
                {post.readTime} read
              </span>
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-white/30 text-8xl font-display font-bold select-none">
                  VQ
                </span>
              </div>
            </div>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-heading font-bold text-brand-text-primary dark:text-white text-sm mb-1">
                    Key Takeaway:
                  </p>
                  <p className="text-brand-text-secondary dark:text-white/70 text-sm leading-relaxed">
                    {post.keyTakeaway}
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-brand-card-dark border border-brand-border-light dark:border-white/10 rounded-xl p-5 mb-8">
              <h3 className="font-heading font-semibold text-brand-text-primary dark:text-white mb-3 text-sm uppercase tracking-wide">
                Table of Contents
              </h3>
                ...
                {TOC_ITEMS.map((item, i) => (
                  <li key={item.id}>
                    ...
                    >
                      ...
                      <span className="text-brand-gold font-mono text-xs w-5 shrink-0">
                        0{i + 1}
                      </span>
            ...
            <div className="my-10 bg-gradient-to-br from-brand-purple to-brand-purple-2 rounded-2xl p-7 text-center relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-white/70 text-sm mb-5">
                  Our team can help you build a complete digital growth system.
                </p>
                <button
                  type="button"
                  onClick={openModal}
            ...
            >
              <span className="text-sm font-heading font-medium text-brand-text-secondary dark:text-white/60">
                Share:
              </span>
              <a
            ...
            >
              {prevPost ? (
                ...
                >
                  ...
                  <span className="text-sm font-heading font-semibold text-brand-text-primary dark:text-white line-clamp-2 group-hover:text-brand-purple dark:group-hover:text-brand-gold transition-colors">
                    {prevPost.title}
                  </span>
                </Link>
              ) : (
          ...
          >
            ...
            <div className="bg-white dark:bg-brand-card-dark rounded-2xl border border-brand-border-light dark:border-white/10 p-5">
              <h3 className="font-heading font-semibold text-brand-text-primary dark:text-white mb-3 text-sm">
                Search Articles
              </h3>
              <div className="relative">
                <input
                  ...
                  onKeyDown={(e) => {
                    if (e.key === "Enter") {
                      ...
                      if (val) router.push(`/blog?q=${encodeURIComponent(val)}`);
                    }
                  }}
                />
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-brand-text-secondary/50 dark:text-white/30 text-sm">
                  🔍
                </span>
              </div>
            </div>
            ...
            {/* Categories */}
            <div className="bg-white dark:bg-brand-card-dark rounded-2xl border border-brand-border-light dark:border-white/10 p-5">
              <h3 className="font-heading font-semibold text-brand-text-primary dark:text-white mb-4 text-sm">
                Categories
              </h3>
                ...
                {SIDEBAR_CATEGORIES.map((cat) => (
                  <li key={cat.name}>
                    ...
                    >
                      ...
                      <span className="text-xs bg-brand-bg-light dark:bg-white/5 px-2 py-0.5 rounded-full font-mono shrink-0 ml-2">
                        {cat.count}
                      </span>
                    </Link>
                  </li>
                ...
                {MOCK_POSTS.slice(0, 3).map((fp, i) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs font-heading font-semibold text-brand-text-primary dark:text-white line-clamp-2 group-hover:text-brand-purple dark:group-hover:text-brand-gold transition-colors leading-snug">
                        {fp.title}
                      </p>
                      <span className="text-xs text-brand-text-secondary dark:text-white/50 font-mono mt-0.5 block">
                        {fp.readTime} read
                      </span>
                    </div>
                  </Link>
            ...
            <div className="bg-white dark:bg-brand-card-dark rounded-2xl border border-brand-border-light dark:border-white/10 p-5">
              ...
              <h3 className="font-heading font-semibold text-brand-text-primary dark:text-white mb-2 text-sm">
                Need Help With Your Digital Strategy?
              </h3>
              <p className="text-brand-text-secondary dark:text-white/60 text-xs mb-4 leading-relaxed">
                Our team of experts is ready to build a custom digital growth
